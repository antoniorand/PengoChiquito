...
void AnimationSystem::update(sf::Time delta,entt::registry& engine){
    ...
    if(frameCounterAnimation < framesToWait){
        frameCounterAnimation++;
        ...
        for(auto entity : view){
            ...
            animationCMP.currentMilliseconds+=(unsigned int)accumulatedTime.asMilliseconds();
        ...
        frameCounterAnimation = 0;
        accumulatedTime = sf::milliseconds(0);
    }
    //////
